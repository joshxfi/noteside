...
<Callout title="Right-click a note">
  A right-click on a note in the sidebar opens a native menu — **Open**, **Reveal in
  Finder/Explorer**, **Duplicate**, **Rename…**, and **Delete** — the same actions as the commands
  above. Delete and Rename open a small confirmation / input dialog.
</Callout>
